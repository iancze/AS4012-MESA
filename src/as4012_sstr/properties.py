...
def rho_func(P, T, X, Y):
    ...
    ..math::
        ...
        \rho = \frac{P \mu m_\mathrm{H}}{k_B T}

    where :math:`\mu` is the dimensionless mean molecular weight. See
    Kippenhahn Eqn 4.22.
    ...
    Returns
    -------
    equation of state in units of :math:`\mathrm{kg}/\mathrm{m}^3`.
    """
...
def kappa_bf(rho, T, X, Z):
    ...
    # not that far off from Kramer's opacity law
    # see Lecture 7 for definition
    c1 = 1.85776232
    c2 = 0.3396116
    c3 = -2.38950921
    c4 = 3.34729929
